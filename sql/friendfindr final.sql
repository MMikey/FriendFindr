...
(4, 'Programming People', 'Do you like programming, computers and everything in between - JOIN NOW!');
...
(29, 'reggie', '1', '$2y$10$NOEgKWuTgCql8jLCeiN2WehmjEzN4WBDxSa6Wdt3nkFUKFxRZSahm', 'bham', 'my name is reg and i am cool', '2021-04-23 22:16:43', '0000-00-00');
...
--
ALTER TABLE `userhobbies`
  MODIFY `userhobbiesId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
