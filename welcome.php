...
function getRecommendedGroups()
{
    ...
    $sql = "SELECT DISTINCT g.groupid, g.name, g.description FROM groups g, grouphobbies gh, userhobbies uh 
            where g.groupid = gh.groupid AND gh.hobbyid = uh.hobbyid AND uh.userid = " . $_SESSION["id"] . ";";
...
?>
    ...
    <section id="banner">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="my-5" style="text-align: center">Hi,
                        <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b></h1>
                    ...
                    <p> Friend findr is a community where users of all backgrounds can interact online,
                        ...
                        This website will give you the opportunity to get out your comfort zone and to meet individuals
                        online despite the intensity
                        of the pandemic. You’ll have the opportunity to interact with other users,
                        discuss interests and hobbies in person or online. It’s also free to create an account so sign
                        up today!!!
                    </p>
                    <a href="#"> </a>
                </div>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-4 services">
                    ...
                    <h4> Home </h4>
                    <p> This is the place we call home. We want users to feel comfortable when browsing our website and
                        feel like they have the freedom to explore, chat and make friends through our free to use
                        services. </p>
                </div>
                <div class="col-md-4 services">
                    <img src="./data/event.jpg" class="service-img">
                    <h4> Events </h4>
                    <p> Users will have the option to sign up to on going events and meet their friends with similar
                ...
                <div class="col-md-4 services">
                    ...
                    <p> Each individual will have their own profile which they can built to suit their style.
                        Users can input a profile picture of their choice and can give a brief description about
                        themselves;
                        other users will then be able to view their profiles and interact with each other through the
                        groups page. </p>
                </div>
            </div>
